...
int sign(const char *filename, const char *SKfilename, char *digest) 
{
	...
	} else if(strcmp(version, "sflashv1") == 0)
	{
		...
		std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/sign.py Sflashv1 " + (std::string)converted + " " + privtmp + " " + sgntmp;;
	...
	} else if(strcmp(version, "sflashv2") == 0)
	{
		...
		std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/sign.py Sflashv2 " + (std::string)converted + " " + privtmp + " " + sgntmp;
		redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
	...
	} else if(strcmp(version, "uov") == 0)
	{
		...
		std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/sign.py UOV 16 40 80 " + (std::string)converted + " " + privtmp + " " + sgntmp;;
		redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
...
int verify(const char *filename, const char *sign, const char *PKfilename)
{
	...
	if(strcmp((char *)signature->version.buf, (char *)PK->version.buf) == 0)
	{
		...
		} else if(strcmp(version, "sflashv1") == 0)
		{
			...
			std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/verify.py Sflashv1 " + (std::string)converted + " " + pubtmp + " " + sgntmp;;
			redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
		...
		} else if(strcmp(version, "sflashv2") == 0)
		{
			...
			std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/sign.py Sflashv2 " + (std::string)converted + " " + pubtmp + " " + sgntmp;
			redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
		...
		} else if(strcmp(version, "uov") == 0)
		{
			...
			std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/sign.py UOV 16 40 80 " + (std::string)converted + " " + pubtmp + " " + sgntmp;;
			redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
...
int verify(const char *filename, const char *sign, MPKCPublicKey_t *PK)
{
	...
	if(strcmp((char *)signature->version.buf, (char *)PK->version.buf) == 0)
	{
		...
		} else if(strcmp(version, "sflashv2") == 0)
		{
			...
			std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/verify.py Sflashv2 " + (std::string)converted + " " + pubtmp + " " + sgntmp;
			redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);
		...
		} else if(strcmp(version, "uov") == 0)
		{
			...
			std::string sage = "sage -python ~/Documents/MAESTRIA/MQCrypto/sage/verify.py UOV 16 40 80 " + (std::string)converted + " " + pubtmp + " " + sgntmp;;
			redi::ipstream proc(sage, redi::pstreams::pstdout | redi::pstreams::pstderr);

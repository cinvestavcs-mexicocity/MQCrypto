#ifndef _HFE_TRANSPOSE8_H
#define _HFE_TRANSPOSE8_H
#include <emmintrin.h>

#define _hfe_transpose8(a,b,c,d,e,f,g,h) {\
...
inline void hfe_transpose8(__m128i t[8], const __m128i s[8]){
	register __m128i a=s[0],b=s[1],c=s[2],d=s[3],e=s[4],f=s[5],g=s[6],h=s[7];
	_hfe_transpose8(a,b,c,d,e,f,g,h);

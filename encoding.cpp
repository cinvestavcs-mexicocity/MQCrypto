...
// 	std::string inputPK = PKfile;
// 	std::string inputSK = SKfile;
// 	std::string outputPK = output;
// 	std::string outputSK = output;
// 	outputPK += "_PK.txt";
// 	outputSK += "_SK.txt";
// 	base64::encoder E;
...
// int base64encodeSignature(const char *inputFile, const char *Sigfile)
// {
// 	std::string input = Sigfile;
// 	std::string output = inputFile;
// 	output += "_signature.txt";
...
//     } 
//     // else {
//     //   	printf("Created %s with BER encoded MPKC Key\n", PKfilename);
//     // }
...
// 	*************************************************************
//     */
//     // if(decodeKeyPair(cryptosystem, pk, pklen, sk, sklen) != 0)
//     // {
//     // 	exit(-1);
//     // }
...
//     // base64decodeKeyPair("Base64EncodedPublicKey.txt", "Base64EncodedPrivateKey.txt");
